...
export default function Footer() {
    return (
        <footer className="w-full py-20 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-black/30 backdrop-blur-sm">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center">
                    <p className="text-gray-400">© 2025 Proactiv. All rights reserved.</p>
